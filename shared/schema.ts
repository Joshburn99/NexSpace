...
export const shifts = pgTable('shifts', {
  ...
  premiumMultiplier: decimal('premium_multiplier', {
    precision: 3,
    scale: 2,
  }).default('1.00'),
...
export const timesheets = pgTable('timesheets', {
  ...
  overtimeHours: decimal('overtime_hours', { precision: 8, scale: 2 }).default(
    '0',
  ),
  holidayHours: decimal('holiday_hours', { precision: 8, scale: 2 }).default(
    '0',
  ),
  sickHours: decimal('sick_hours', { precision: 8, scale: 2 }).default('0'),
  vacationHours: decimal('vacation_hours', { precision: 8, scale: 2 }).default(
    '0',
  ),
...
export const insertPayrollProviderSchema = createInsertSchema(
  payrollProviders,
).omit({
  id: true,
  createdAt: true,
...
export const insertPayrollConfigurationSchema = createInsertSchema(
...
export const insertPayrollEmployeeSchema = createInsertSchema(
  payrollEmployees,
).omit({
  id: true,
  createdAt: true,
...
export const insertTimesheetEntrySchema = createInsertSchema(
  timesheetEntries,
).omit({
  id: true,
  createdAt: true,
...
export const insertPayrollSyncLogSchema = createInsertSchema(
  payrollSyncLogs,
).omit({
  id: true,
});
...
export type InsertPayrollConfiguration = z.infer<
  typeof insertPayrollConfigurationSchema
>;
