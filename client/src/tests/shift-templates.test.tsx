...
describe('Shift Templates Page', () => {
  ...
  it('renders the shift templates page correctly', async () => {
    ...
    expect(screen.getByText('Create, manage, and schedule recurring shift patterns')).toBeInTheDocument();
  ...
  it('submits create template form with enhanced facility data', async () => {
    ...
    await waitFor(() => {
      expect(fetch).toHaveBeenCalledWith('/api/shift-templates', expect.objectContaining({
        method: 'POST',
