  ...
  return (
    <Switch>
      ...
      <ProtectedRoute
        ...
        component={SchedulingConfigPage}
      />
      ...
      <ProtectedRoute
        ...
        component={EnhancedReferralPage}
      />
      ...
      <ProtectedRoute
        path="/admin/database"
        component={AdminDatabaseConsolePage}
      />
      <ProtectedRoute
      ...
      <ProtectedRoute
        ...
        component={ContractorDashboardWrapper}
      />
      <ProtectedRoute
        path="/facility-recommendations"
        component={FacilityRecommendationsPage}
      />
      <ProtectedRoute
        path="/detailed-shift-analytics"
        component={DetailedShiftAnalyticsPage}
      />
