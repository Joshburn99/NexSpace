...
import NexspaceFullLogo from "@assets/nexspace-full-logo.svg";
import { 
  ChevronDown, 
  BarChart3, 
  Calendar, 
...
const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Agency Usage", href: "/analytics/agency", icon: <BarChart3 className="w-4 h-4" /> },
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        {expanded ? (
          <div className="flex items-center">
            <img src={NexspaceFullLogo} alt="NexSpace" className="h-8" />
          </div>
        ) : (
          <img src={NexspaceFullLogo} alt="NexSpace" className="h-8 w-8" />
        )}
        {onToggle && (
          <Button
            variant="ghost"
