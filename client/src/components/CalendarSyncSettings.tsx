        ...
        <CardContent className="space-y-6">
            ...
            {syncStatus?.icalFeed?.enabled && syncStatus?.icalFeed?.url && (
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input value={syncStatus.icalFeed.url} readOnly className="font-mono text-sm" />
                  <Button
                    size="icon"
                    variant="outline"
                ...
                <p className="text-xs text-muted-foreground">
                  Copy this URL and add it to your calendar app (Google Calendar, Apple Calendar,
                  Outlook, etc.)
                </p>
              </div>
            )}
          ...
          <div className="border-t pt-6">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                • <strong>iCal Feed:</strong> Copy the URL and add it to your calendar app's
                subscription feature
              </li>
              <li>
                • <strong>Google Calendar:</strong> Connect your account for automatic sync of all
                shifts
              </li>
