...
const sampleMessages: Message[] = [
  {
    ...
    content:
      "Hi, I need to request a schedule change for next week due to a family emergency. Please let me know if this is possible.",
  ...
  },
  {
    ...
    content:
      "I have renewed my BLS certification. Please update my profile with the new expiration date.",
  ...
  },
  {
    ...
    content:
      "Your schedule change request has been approved. Please check your updated schedule in the calendar.",
  ...
  useEffect(() => {
    if (messages.length > 0) {
      const userMessages = messages.filter(
        (msg) => !sampleMessages.find((sample) => sample.id === msg.id)
      );
