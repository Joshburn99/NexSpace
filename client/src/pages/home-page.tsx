...
const priorityTasks: PriorityTask[] = [
  ...
  },
  {
    ...
    description:
      'ICU unit below minimum staffing ratio - immediate attention required',
    priority: 'critical',
    type: 'compliance',
    route: '/compliance',
  },
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab}>
              ...
              <Link href="/scheduling">
                <Card className="cursor-pointer hover:shadow-md transition-shadow">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Current staffing status across all units
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        >
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 mt-2 text-xs">
                              {Object.entries(shift.required).map(
                                ([role, count]) => (
                                  <div
                                    key={role}
          ...
          <TabsContent value="settings">
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                Configure system preferences, user settings, and facility
                management
              </p>
              <Link href="/settings">
                <Button>
