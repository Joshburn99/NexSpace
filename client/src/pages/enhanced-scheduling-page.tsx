            ...
            <div className="grid grid-cols-8 gap-2">
              ...
              {weekDates.map((date) => (
                <div key={date.toISOString()} className="text-center p-3 border-b">
                  <div className="font-medium text-sm text-gray-900">{format(date, "EEE")}</div>
                  <div
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewShift({ ...newShift, requiredStaff: parseInt(e.target.value) })
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewShift({ ...newShift, hourlyRate: parseFloat(e.target.value) })
                  }
                />
              </div>
            </div>
