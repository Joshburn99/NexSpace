...
const workflowTemplates = [
  {
    ...
    type: 'invoice',
    description:
      'Automatically approve invoices under $5,000 from verified contractors',
    isActive: true,
    conditions: [
    ...
    actions: [
      { type: 'set_status', value: 'approved' },
      {
        ...
        recipients: ['contractor', 'facility_manager'],
      },
  ...
  },
  {
    ...
    type: 'work_log',
    description:
      'Fast-track work logs with overtime hours for immediate review',
    isActive: true,
    conditions: [
  ...
  },
  {
    ...
    type: 'both',
    description:
      'Flag submissions missing required credentials or documentation',
    isActive: true,
    conditions: [
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Automate invoice and work log processing with intelligent rules
            </p>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {workflowTemplates.filter(w => w.isActive).length}
                  </p>
                </div>
          ...
          <TabsContent value="create" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Build custom automation rules for invoice and work log
                  processing
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setNewWorkflow(prev => ({ ...prev, type: value }))
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  {newWorkflow.conditions.map((condition, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <SelectContent>
                          {conditionFields[
                            newWorkflow.type as keyof typeof conditionFields
                          ]?.map(field => (
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={checked =>
                      setNewWorkflow(prev => ({ ...prev, isActive: checked }))
                    }
                  />
