...
import { Upload, DollarSign, TrendingUp, Building, FileText, Users, PieChart, BarChart3 } from "lucide-react";
...
export default function AgencyUsagePage() {
  ...
  const averageAgencyRate = mockAgencyData.reduce((sum, agency) => sum + agency.averageRate, 0) / mockAgencyData.length;
  const averageMarketRate = mockAgencyData.reduce((sum, agency) => sum + agency.marketRate, 0) / mockAgencyData.length;
  const overMarketPercentage = ((averageAgencyRate - averageMarketRate) / averageMarketRate * 100).toFixed(1);
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Total Agency Spend</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Float Pool Savings</p>
                    <p className="text-2xl font-bold text-green-600">${totalFloatPoolSavings.toLocaleString()}</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Over Market Rate</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Active Agencies</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload and process agency invoices for cost tracking
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Internal float pool cost savings vs agency rates
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div key={pool.id} className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                      ...
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-green-600">${pool.savingsVsAgency.toLocaleString()}</p>
                        </div>
                      </div>
                    </div>
                  ))}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed analysis by agency and specialty
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {mockAgencyData.map((agency) => (
                  <div key={agency.id} className="flex items-center justify-between p-4 border rounded-lg hover:shadow-md transition-shadow">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className={`font-bold ${agency.costDifference > 0 ? 'text-red-600' : 'text-green-600'}`}>
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        <div className="text-xs text-gray-500">
                          {agency.invoicesCount} invoices • Last: {new Date(agency.lastInvoiceDate).toLocaleDateString()}
                        </div>
                        <div className="text-xs">
                          <span className={`${agency.costDifference > 2 ? 'text-red-600' : agency.costDifference < 0 ? 'text-green-600' : 'text-yellow-600'}`}>
                            {agency.costDifference > 2 ? 'High Cost' : agency.costDifference < 0 ? 'Below Market' : 'Market Rate'}
                          </span>
                        </div>
                      </div>
                    </div>
