...
const mockParticipants: Participant[] = [
  ...
  },
  {
    ...
    contactInfo: {
      phone: '(555) 234-5678',
      email: 'mchen.contractor@email.com',
    },
  },
  {
    id: 'user3',
  ...
  },
  {
    ...
    contactInfo: {
      phone: '(555) 456-7890',
      email: 'david.park@contractor.com',
    },
  },
  {
    id: 'user5',
  ...
  },
  {
    ...
    contactInfo: {
      phone: '(555) 678-9012',
      email: 'james.miller@facility.com',
    },
  },
  {
    id: 'user7',
    ...
    contactInfo: {
      phone: '(555) 789-0123',
      email: 'maria.garcia@facility.com',
    },
  },
];
...
const mockMessages: Message[] = [
  ...
  },
  {
    ...
    senderRole: 'LPN',
    content:
      'Patient in room 204 needs immediate attention. Vital signs are concerning.',
  ...
  },
  {
    ...
    senderRole: 'Manager',
    content:
      'Team meeting tomorrow at 9 AM. Please review the new protocols before attending.',
  ...
  const getFilteredParticipants = () => {
    ...
    if (massMessageData.selectedGroup) {
      const group = presetGroups.find(
        g => g.id === massMessageData.selectedGroup,
      );
      if (group) {
    ...
    if (massMessageData.customFilters.unit) {
      filtered = filtered.filter(
        p => p.unit === massMessageData.customFilters.unit,
      );
    }
    if (massMessageData.customFilters.role) {
      filtered = filtered.filter(
        p => p.role === massMessageData.customFilters.role,
      );
    }
    if (massMessageData.customFilters.type) {
      filtered = filtered.filter(
        p => p.type === massMessageData.customFilters.type,
      );
    }
            ...
            <TabsContent value="individual" className="space-y-4">
              <div className="max-h-48 overflow-auto space-y-2">
                {mockParticipants.map(participant => (
                  ...
                  >
                    <Checkbox
                      checked={massMessageData.selectedIndividuals.includes(
                        participant.id,
                      )}
                      onCheckedChange={checked => {
                        if (checked) {
                          ...
                          setMassMessageData({
                            ...massMessageData,
                            selectedIndividuals:
                              massMessageData.selectedIndividuals.filter(
