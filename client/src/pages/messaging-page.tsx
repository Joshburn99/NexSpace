...
const mockParticipants: Participant[] = [
  ...
  },
  {
    ...
    type: "contractor",
    status: "online",
    contactInfo: { phone: "(555) 456-7890", email: "david.park@contractor.com" },
  },
  {
    id: "user5",
    firstName: "Lisa",
    ...
    type: "employee",
    status: "online",
    contactInfo: { phone: "(555) 567-8901", email: "lisa.wang@facility.com" },
  },
  {
    id: "user6",
    firstName: "James",
    ...
    type: "employee",
    status: "offline",
    contactInfo: { phone: "(555) 678-9012", email: "james.miller@facility.com" },
  },
  {
    id: "user7",
    firstName: "Maria",
    ...
    type: "employee",
    status: "online",
    contactInfo: { phone: "(555) 789-0123", email: "maria.garcia@facility.com" },
  },
];
...
const mockMessages: Message[] = [
  {
    ...
    senderRole: "RN",
    content: "Hi, can you cover my shift tonight? I have a family emergency.",
    timestamp: new Date(2025, 5, 17, 14, 30),
    isRead: false,
    messageType: "direct",
    priority: "urgent",
  },
  {
    ...
    senderName: "You",
    senderRole: "Manager",
    content: "Of course! I'll find someone to cover. Take care of your family.",
    timestamp: new Date(2025, 5, 17, 14, 35),
    isRead: true,
    messageType: "direct",
    priority: "normal",
  },
  {
    ...
    senderRole: "LPN",
    content: "Patient in room 204 needs immediate attention. Vital signs are concerning.",
    timestamp: new Date(2025, 5, 17, 15, 15),
    isRead: false,
    messageType: "direct",
    priority: "urgent",
  },
  {
    ...
    senderRole: "Manager",
    content: "Team meeting tomorrow at 9 AM. Please review the new protocols before attending.",
    timestamp: new Date(2025, 5, 17, 16, 0),
    isRead: true,
    messageType: "group",
    priority: "normal",
  },
  {
    ...
    senderRole: "RN",
    content: "Can someone help with the patient transfer in room 312?",
    timestamp: new Date(2025, 5, 17, 16, 30),
    isRead: false,
    messageType: "direct",
    priority: "high",
  },
...
const mockConversations: Conversation[] = [
  ...
  {
    id: "conv4",
    participants: [mockParticipants[6]],
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        {conversation.lastMessage.priority !== "normal" && (
                          <Badge
                            className={cn(
                              "text-xs",
                              getPriorityColor(conversation.lastMessage.priority)
                            )}
                          >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-4 mt-1 text-xs text-gray-500">
                        ...
                        <Badge
                          variant={participant.type === "employee" ? "default" : "secondary"}
                          className="text-xs"
                        >
                          {participant.type}
                        </Badge>
              ...
              <div className="bg-white border-b px-6 py-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <Avatar className="h-10 w-10">
                      <AvatarFallback>
                        {mockConversations.find((c) => c.id === selectedConversation)?.type ===
                        "group" ? (
                          <Users className="h-5 w-5" />
                        ) : (
                          "SJ"
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewMessageData({ ...newMessageData, recipient: value })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: "normal" | "high" | "urgent") =>
                  setNewMessageData({ ...newMessageData, priority: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
      ...
      <Dialog open={showMassMessage} onOpenChange={setShowMassMessage}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Send a message to multiple team members using filters or groups
            </DialogDescription>
          </DialogHeader>
          ...
          <Tabs defaultValue="groups" className="space-y-4">
            ...
            <TabsContent value="groups" className="space-y-4">
              <div>
                ...
                <Select
                  value={massMessageData.selectedGroup}
                  onValueChange={(value) =>
                    setMassMessageData({ ...massMessageData, selectedGroup: value })
                  }
                >
                  <SelectTrigger>
              ...
              {massMessageData.selectedGroup && (
                <div className="bg-blue-50 p-3 rounded-lg">
                  <p className="text-sm font-medium">
                    Recipients: {getFilteredParticipants().length} people
                  </p>
            ...
            <TabsContent value="filters" className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label>Unit</Label>
                  <Select
                    value={massMessageData.customFilters.unit}
                    onValueChange={(value) =>
                      setMassMessageData({
                        ...massMessageData,
                ...
                <div>
                  <Label>Role</Label>
                  <Select
                    value={massMessageData.customFilters.role}
                    onValueChange={(value) =>
                      setMassMessageData({
                        ...massMessageData,
                ...
                <div>
                  ...
                  <Select
                    value={massMessageData.customFilters.type}
                    onValueChange={(value) =>
                      setMassMessageData({
                        ...massMessageData,
                      ...
                      onCheckedChange={(checked) => {
                        if (checked) {
                          setMassMessageData({
                            ...massMessageData,
                            selectedIndividuals: [
                              ...massMessageData.selectedIndividuals,
                              participant.id,
                            ],
                          });
                        } else {
                          setMassMessageData({
                            ...massMessageData,
                            selectedIndividuals: massMessageData.selectedIndividuals.filter(
          ...
          <div className="space-y-4 pt-4 border-t">
            <div>
              ...
              <Select
                ...
                onValueChange={(value: "normal" | "high" | "urgent") =>
                  setMassMessageData({ ...massMessageData, priority: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setMassMessageData({ ...massMessageData, subject: e.target.value })
                }
                placeholder="Message subject"
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setMassMessageData({ ...massMessageData, content: e.target.value })
                }
                placeholder="Type your message..."
                className="min-h-[100px]"
              />
