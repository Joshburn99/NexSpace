  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const processedData = {
      ...
      defaultShiftDuration:
        parseInt(formData.get('defaultShiftDuration') as string) || 8,
      overtimeThreshold:
        parseInt(formData.get('overtimeThreshold') as string) || 40,
      sessionTimeout: parseInt(formData.get('sessionTimeout') as string) || 30,
      passwordMinLength:
        parseInt(formData.get('passwordMinLength') as string) || 8,
    };
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      name="dateFormat"
                      defaultValue={currentSettings.dateFormat}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      name="currency"
                      defaultValue={currentSettings.currency}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
          ...
          <TabsContent value="notifications" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="backupEmailFrequency">
                    Backup Email Frequency
                  </Label>
                  <Select
          ...
          <TabsContent value="shifts" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="autoApproveShifts">
                      Auto-approve Shifts
                    </Label>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="requireManagerApproval">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="allowSelfCancellation">
