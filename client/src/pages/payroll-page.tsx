...
export default function PayrollPage() {
  ...
  const updateTimesheetStatusMutation = useMutation({
    mutationFn: async ({ id, status }: { id: number; status: string }) => {
      const res = await apiRequest('PUT', `/api/timesheets/${id}/status`, {
        status,
      });
      return await res.json();
    },
  ...
  const handleProcessPayroll = () => {
    if (!payPeriodStart || !payPeriodEnd) {
      toast({
        ...
        description:
          'Please select both start and end dates for the pay period',
        variant: 'destructive',
      });
      return;
    }
  ...
  const pendingTimesheets = timesheets.filter((t: Timesheet) =>
  ...
  const totalPendingAmount = pendingPayments.reduce(
    (sum, p) => sum + parseFloat(p.netAmount),
    0,
  );
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="flex items-end">
                  <Button
                    ...
                    disabled={
                      processingPayroll || processPayrollMutation.isPending
                    }
                    className="w-full"
                  >
                    {processingPayroll ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium">
                          {log.syncType.replace('_', ' ').toUpperCase()}
                        </p>
                  ...
                  <TableBody>
                    {timesheets.map((timesheet: Timesheet) => (
                      <TableRow key={timesheet.id}>
                        ...
                        <TableCell>
                          <Badge
                            className={getStatusBadgeColor(timesheet.status)}
                          >
                            {timesheet.status}
                          </Badge>
                        </TableCell>
        ...
        <TabsContent value="employees" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage payroll configuration for employees
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loadingEmployees ? (
                  ...
                  <TableBody>
                    {payrollEmployees.map((employee: PayrollEmployee) => (
                      <TableRow key={employee.id}>
                        ...
                        <TableCell>
                          ${parseFloat(employee.overtimeRate || '0').toFixed(2)}
                        </TableCell>
                        <TableCell>
                          <Badge
                            className={
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Real-time payroll processing information
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      Payroll processing runs automatically every bi-weekly
                      period. Manual processing is available for corrections or
                      off-cycle runs.
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      Friday, June 28, 2025 at 2:00 AM
                    </p>
                  </div>
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      Friday, June 14, 2025 at 2:00 AM
                    </p>
                    <p className="text-sm text-green-600">
                      ✓ 47 timesheets processed successfully
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  External payroll provider connections
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
