        ...
        <TabsContent value="overview" className="space-y-6 mt-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Synchronize data with external payroll providers</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <TableBody>
                    {timesheets.map((timesheet: Timesheet) => (
                      <TableRow key={timesheet.id}>
                        ...
                        <TableCell>
                          {new Date(timesheet.payPeriodStart).toLocaleDateString()} -{" "}
                          {new Date(timesheet.payPeriodEnd).toLocaleDateString()}
                        </TableCell>
              ...
              <CardContent>
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      Payroll processing runs automatically every bi-weekly period. Manual
                      processing is available for corrections or off-cycle runs.
                    </AlertDescription>
                  </Alert>
