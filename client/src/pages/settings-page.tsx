        ...
        {isSuperUser && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Switch between different app views to experience various user perspectives and role
                interfaces
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <CardContent className="p-4">
                        <div className="flex flex-col items-center text-center space-y-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-600">Basic clinician dashboard</p>
                          </div>
                          {appView === "clinician" && (
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-700">
                        Switch between facility management, clinician, employee, and contractor
                        views to experience role-specific dashboards and interfaces. Each view shows
                        different data, tools, and workflows relevant to that user type.
                      </p>
                    </div>
                  </div>
                </div>
