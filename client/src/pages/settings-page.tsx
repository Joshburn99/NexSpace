        ...
        {isSuperUser && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Switch between different app views to experience various user
                perspectives and role interfaces
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-700">
                        Switch between facility management, clinician, employee,
                        and contractor views to experience role-specific
                        dashboards and interfaces. Each view shows different
                        data, tools, and workflows relevant to that user type.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Reminders before upcoming shifts
                  </p>
                </div>
                <Switch
                  id="shiftReminders"
