...
export default function EnhancedStaffPage() {
  ...
  const filteredStaff = staffMembers.filter(staff => {
    ...
    return (
      matchesSearch && matchesWorkerType && matchesSpecialty && matchesStatus
    );
  });
            ...
            <DialogContent className="max-w-2xl">
              ...
              <form onSubmit={handleCreateStaff} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select name="workerType" required>
                      ...
                      <SelectContent>
                        {Object.entries(workerTypeLabels).map(
                          ([value, label]) => (
                ...
                <div>
                  ...
                  <Input
                    name="certifications"
                    placeholder="BLS, ACLS, RN License"
                  />
                </div>
            ...
            {filteredStaff.map(staff => (
              ...
              >
                ...
                <CardContent className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Badge
                      className={`${statusColors[staff.status]} text-white`}
                    >
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center">
                      <DollarSign className="h-3 w-3 mr-1" />${staff.hourlyRate}
                      /hr
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {
                        staffMembers.filter(
                          s => s.workerType === 'contractor_1099',
                        ).length
                      }
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {(
                        staffMembers.reduce((sum, s) => sum + s.rating, 0) /
                        staffMembers.length
                      ).toFixed(1)}
                    </p>
                  </div>
