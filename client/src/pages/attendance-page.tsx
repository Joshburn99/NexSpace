...
export default function AttendancePage() {
  ...
  const cancelRate = (
    ((attendanceStats.cancelledShifts + attendanceStats.ncnsShifts) / attendanceStats.totalShifts) *
    100
  ).toFixed(1);
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {((attendanceStats.cancelledShifts / attendanceStats.totalShifts) * 100).toFixed(
                    1
                  )}
                  %
                </p>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {((attendanceStats.ncnsShifts / attendanceStats.totalShifts) * 100).toFixed(1)}%
                </p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {((attendanceStats.onTimeShifts / attendanceStats.totalShifts) * 100).toFixed(1)}%
                </p>
              </div>
            ...
            {filteredData.map((record) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  {record.notes && (
                    <p className="text-xs text-gray-500 mt-1 max-w-32">{record.notes}</p>
                  )}
                </div>
