...
export default function StaffDirectory() {
  ...
  const handleMessageClick = (staffMember: Staff) => {
    ...
    navigate(
      `/messages?recipient=${staffMember.id}&name=${encodeURIComponent(`${staffMember.firstName || ""} ${staffMember.lastName || ""}`)}`
    );
  };
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      <p className="text-gray-600">
                                        {member.bio ||
                                          `Experienced ${member.specialty} with expertise in patient care.`}
                                      </p>
                                      ...
                                      <div>
                                        ...
                                        <div className="flex items-center space-x-1">
                                          ...
                                          <span className="text-lg">
                                            {member.rating || member.reliabilityScore || "4.8"}/5
                                          </span>
                                        </div>
                                      </div>
                                      <div>
                                        ...
                                        <p className="text-lg">
                                          {member.totalShifts || member.totalWorkedShifts || "156"}
                                        </p>
                                      </div>
                                    </div>
                                  </div>
