        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
              ...
              >
                Urgent (
                {mockOpenShifts.filter(s => s.priority === 'urgent').length})
              </Button>
              <Button
              ...
              >
                High Priority (
                {mockOpenShifts.filter(s => s.priority === 'high').length})
              </Button>
            </div>
          </div>
          ...
          {filteredShifts.length === 0 && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
                No {filter !== 'all' ? filter + ' priority ' : ''}shifts
                available
              </h3>
