  ...
  const analytics = {
    staffing: {
      totalStaff: Array.isArray(users)
        ? users.filter((u: any) => u.role === 'INTERNAL_EMPLOYEE').length
        : 0,
      activeStaff: Array.isArray(users)
        ? users.filter((u: any) => u.role === 'INTERNAL_EMPLOYEE' && u.isActive)
            .length
        : 0,
      contractors: Array.isArray(users)
        ? users.filter((u: any) => u.role === 'CONTRACTOR_1099').length
        : 0,
      openPositions: Array.isArray(jobs)
    ...
    scheduling: {
      ...
      fillRate:
        shifts.length > 0
          ? ((bookedShifts.length / shifts.length) * 100).toFixed(1)
          : '0',
      avgShiftLength: 8.5,
    ...
    compliance: {
      credentialCompliance:
        Array.isArray(credentials) && credentials.length > 0
          ...
          : '0',
      expiringCredentials: Array.isArray(credentials)
        ...
        <TabsContent value="overview" className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-blue-600">
                      {analytics.quality.staffSatisfaction}
                    </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-purple-600">
                      {analytics.compliance.credentialCompliance}%
                    </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-emerald-600">
                      ${(analytics.financial.monthlyRevenue / 1000).toFixed(0)}k
                    </p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                6-month performance trends across key metrics
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="space-y-2">
                    {trendData.map((data, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <Progress
                            value={data.staffSatisfaction * 20}
                            className="w-20"
                          />
                          <span className="text-sm font-medium">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">
                    {analytics.staffing.totalStaff}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Active Staff</span>
                  <span className="font-bold text-green-600">
                    {analytics.staffing.activeStaff}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Contractors</span>
                  <span className="font-bold text-blue-600">
                    {analytics.staffing.contractors}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Open Positions</span>
                  <span className="font-bold text-orange-600">
                    {analytics.staffing.openPositions}
                  </span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="font-bold">
                      {analytics.staffing.staffUtilization}%
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="font-bold">
                      {analytics.staffing.avgReliabilityScore}%
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="font-bold">
                      {analytics.quality.retentionRate}%
                    </span>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <Badge className="bg-blue-100 text-blue-800">
                    {analytics.quality.staffSatisfaction}/5.0
                  </Badge>
                </div>
                <div className="flex justify-between">
                  ...
                  <Badge
                    className={
                      analytics.quality.turnoverRate < 15
                ...
                <div className="flex justify-between">
                  ...
                  <Badge className="bg-purple-100 text-purple-800">
                    {analytics.quality.timeToFill} days
                  </Badge>
                </div>
                <div className="flex justify-between">
                  <span>Incident Rate</span>
                  <Badge className="bg-green-100 text-green-800">
                    {analytics.quality.incidentRate}%
                  </Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">
                    {analytics.scheduling.totalShifts}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Filled Shifts</span>
                  <span className="font-bold text-green-600">
                    {analytics.scheduling.filledShifts}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Open Shifts</span>
                  <span className="font-bold text-red-600">
                    {analytics.scheduling.openShifts}
                  </span>
                </div>
                <div>
                  <div className="flex justify-between mb-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">
                    {analytics.scheduling.avgShiftLength} hours
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Emergency Coverage</span>
                  <Badge className="bg-green-100 text-green-800">
                    {analytics.scheduling.emergencyCoverage}%
                  </Badge>
                </div>
                <div className="flex justify-between">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="font-bold">
                      {analytics.compliance.trainingCompliance}%
                    </span>
                  </div>
                ...
                <div className="flex justify-between">
                  ...
                  <Badge
                    className={
                      analytics.compliance.expiringCredentials > 5
                        ? 'bg-red-100 text-red-800'
                        : 'bg-green-100 text-green-800'
                    }
                  >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <Badge className="bg-green-100 text-green-800">
                    {analytics.compliance.auditScore}%
                  </Badge>
                </div>
                <div className="flex justify-between">
                  <span>Last Audit</span>
                  <span className="text-sm text-gray-600">
                    {analytics.compliance.lastAuditDate}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Next Audit Due</span>
                  <span className="text-sm text-gray-600">
                    {analytics.compliance.nextAuditDue}
                  </span>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-green-600">
                    ${analytics.financial.monthlyRevenue.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Staffing Costs</span>
                  <span className="font-bold text-red-600">
                    ${analytics.financial.staffingCosts.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Contractor Costs</span>
                  <span className="font-bold text-blue-600">
                    ${analytics.financial.contractorCosts.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Avg Hourly Rate</span>
                  <span className="font-bold">
                    ${analytics.financial.avgHourlyRate}
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <Badge
                    className={
                      analytics.financial.profitMargin > 5
                        ? 'bg-green-100 text-green-800'
                ...
                <div className="flex justify-between">
                  ...
                  <Badge
                    className={
                      analytics.financial.budgetVariance < 0
                        ? 'bg-red-100 text-red-800'
                        : 'bg-green-100 text-green-800'
                    }
                  >
                ...
                <div className="p-3 bg-yellow-50 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    ...
                    Budget variance indicates slightly higher than expected
                    costs
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <Badge className="bg-green-100 text-green-800">
                    {analytics.quality.patientSatisfaction}/5.0
                  </Badge>
                </div>
                <div className="flex justify-between">
                  <span>Staff Satisfaction</span>
