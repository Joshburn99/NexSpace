...
const mockJobPostings: JobPosting[] = [
  {
    ...
    description:
      "Join our award-winning 20-bed ICU providing critical care to our most vulnerable patients. We offer competitive compensation, excellent benefits, and opportunities for professional growth in a state-of-the-art facility.",
  ...
  },
  {
    ...
    description:
      "Support our 35-bed Medical-Surgical unit providing comprehensive care to adult patients. Excellent opportunity for career advancement with mentorship programs and continuing education support.",
  ...
  },
  {
    ...
    description:
      "Provide compassionate care to residents in our specialized 25-bed Memory Care unit. Training provided for dementia-specific care approaches including validation therapy and person-centered care.",
  ...
  },
  {
    ...
    description:
      "Lead our 20-bed Rehabilitation unit helping patients regain independence. Modern equipment and collaborative team environment with focus on evidence-based practice and patient outcomes.",
  ...
  },
  {
    ...
    description:
      "Immediate opening for experienced ICU nurse. Competitive travel rates, housing stipend, and comprehensive benefits package. Join our team for a rewarding temporary assignment.",
    department: "Intensive Care Unit",
    payRateMin: 55,
    payRateMax: 70,
    jobType: "contract",
  ...
  },
  {
    ...
    description:
      "Weekend position floating between all units. Premium weekend differential. Perfect for work-life balance while maintaining clinical skills across multiple specialties.",
  ...
  },
  {
    ...
    description:
      "Per diem position providing occupational therapy services across all units. Flexible scheduling with competitive hourly rates for experienced therapists.",
    department: "Rehabilitation",
    payRateMin: 38,
    payRateMax: 45,
    jobType: "part-time",
  ...
  },
  {
    ...
    description:
      "Lead our night shift operations across all units. Supervisory experience required. Excellent opportunity for leadership development with management support.",
...
const mockApplications: JobApplication[] = [
  {
    ...
    status: "pending",
    coverLetter:
      "I am excited to apply for the ICU RN position. With 5 years of critical care experience...",
...
export default function EnhancedJobBoard() {
  ...
  const handleApplyToJob = () => {
    ...
    setJobPostings((prev) =>
      prev.map((job) =>
        job.id === selectedJob.id ? { ...job, applicationsCount: job.applicationsCount + 1 } : job
      )
    );
              ...
              <Dialog open={isCreateJobOpen} onOpenChange={setIsCreateJobOpen}>
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>Post a new position for your facility</DialogDescription>
                  </DialogHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setNewJob((prev) => ({ ...prev, department: value }))
                        }
                      >
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: "full-time" | "part-time" | "contract") =>
                          setNewJob((prev) => ({ ...prev, jobType: value }))
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewJob((prev) => ({ ...prev, payRateMin: e.target.value }))
                        }
                        placeholder="25.00"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewJob((prev) => ({ ...prev, payRateMax: e.target.value }))
                        }
                        placeholder="35.00"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setNewJob((prev) => ({ ...prev, requirements: e.target.value }))
                        }
