            ...
            <Dialog>
              ...
              <DialogContent className="max-w-4xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Configure reliability score thresholds for automatic shift
                    assignments based on request timing.
                  </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Reliability score thresholds for employees
                      </CardDescription>
                    </CardHeader>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center space-x-2">
                            ...
                            <Badge
                              className={getStaffTypeColor(request.staffType)}
                            >
                              {request.staffType === 'employee'
                                ? 'Employee'
                                : 'Contractor'}
                            </Badge>
                            {request.isFavorite && (
                          ...
                          {request.reliabilityScore >=
                            getAutoApprovalThreshold(request) &&
                        ...
                        {request.status === 'pending' && (
                          <div className="flex space-x-2">
                            <Button
                              ...
                              variant={
                                request.isFavorite ? 'default' : 'outline'
                              }
                            >
                              <Star
                                className={cn(
                                  'w-4 h-4',
                                  request.isFavorite && 'fill-current',
                                )}
                              />
                            </Button>
                            <Button
                ...
                {filteredRequests.length === 0 && (
                  <Card className="p-12 text-center">
                    <div className="text-gray-500">
                      ...
                      <p>
                        There are no shift requests in the {selectedTab}{' '}
                        category.
                      </p>
                    </div>
                  </Card>
