        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">Manage professional credentials and certifications</p>
            </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage and track your professional credentials
              </CardDescription>
            </CardHeader>
            <CardContent>
              {credentials.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 mb-4">
                    Add your professional credentials to get started
                  </p>
                  <Button onClick={() => setShowAddCredential(true)}>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                              ...
                              <p><strong>Issuing Authority:</strong> {credential.issuingAuthority}</p>
                              <p><strong>Expiry Date:</strong> {new Date(credential.expiryDate).toLocaleDateString()}</p>
                              {credential.verifiedAt && (
                                <p><strong>Verified:</strong> {new Date(credential.verifiedAt).toLocaleDateString()}</p>
                              )}
                            </div>
                          </div>
                          <div className="flex gap-2">
