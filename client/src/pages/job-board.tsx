          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Discover healthcare opportunities and connect with top
                facilities
              </p>
            </div>
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Create a new job posting to attract qualified healthcare
                      professionals.
                    </DialogDescription>
                  </DialogHeader>
                  <Form {...jobForm}>
                    <form
                      onSubmit={jobForm.handleSubmit(handleCreateJob)}
                      className="space-y-4"
                    >
                      <FormField
                          ...
                          (user?.role === UserRole.INTERNAL_EMPLOYEE ||
                            ...
                            <Dialog>
                              <DialogTrigger asChild>
                                <Button
                                  onClick={() =>
                                    applicationForm.setValue('jobId', job.id)
                                  }
