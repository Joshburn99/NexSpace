...
export const floatPoolMarginsSchema = z.record(z.string(), z.number().min(0).max(100))
  .optional()
  .nullable();

export const specialtyRatesSchema = z.record(z.string(), z.number().min(0).max(500))
  .optional()
  .nullable();

export const workflowAutomationConfigSchema = z.object({
...
export const shiftManagementSettingsSchema = z.object({
...
export const staffingTargetsSchema = z.record(
  z.string(),
  z.object({
...
export const regulatoryDocsSchema = z.array(
  z.object({
    id: z.string(),
    name: z.string(),
