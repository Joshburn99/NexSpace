...
async function generateCompletedShifts() {
  console.log('Generating completed shifts...');
...
async function generateCredentialHistory() {
  console.log('Generating credential history...');
...
async function generateProfessionalInvoices() {
  console.log('Generating professional invoices...');
...
async function generateTimesheetRecords() {
  console.log('Generating timesheet records...');
...
async function generateWorkLogs() {
  console.log('Generating work logs...');
