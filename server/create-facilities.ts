  ...
  try {
    const facilityData = [
      ...
      },
      {
        ...
        bedCount: 120,
        description:
          'Skilled nursing facility specializing in long-term care and rehabilitation',
        cmsId: '140002',
        overallRating: 4.5,
        staffingRating: 4.6,
        qualityRating: 4.4,
      ...
      },
      {
        ...
        bedCount: 80,
        description:
          'Luxury assisted living community with memory care services',
        overallRating: 4.7,
        staffingRating: 4.8,
        qualityRating: 4.6,
        safetyRating: 4.7,
      },
      {
        ...
        bedCount: 200,
        description:
          'Major teaching hospital with trauma center and specialty services',
        cmsId: '140003',
        overallRating: 4.0,
        staffingRating: 3.9,
        qualityRating: 4.1,
      ...
      },
      {
        ...
        bedCount: 24,
        description:
          'Compassionate end-of-life care with family support services',
        overallRating: 4.9,
        staffingRating: 4.9,
        qualityRating: 4.8,
        safetyRating: 4.9,
